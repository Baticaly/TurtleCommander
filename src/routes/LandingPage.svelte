...
<div class="m-0 px-14 py-10 w-full h-screen overflow-hidden">
	...
	<div class="flex flex-row h-20 gap-3">
		<img src="src/assets/logo1.svg" alt="Logo1" />
	...
	<div class="flex justify-between flex-row h-full px-12 -mt-8">
		<div class="flex flex-col justify-center basis-6/12">
			...
			<!-- Button -->
			<div
				class="bg-buttonBackground text-buttonText text-lg rounded-full drop-shadow-xl w-48 flex justify-center py-2 font-bold mt-8 hover:bg-[#f2cb99] hover:cursor-pointer"
			>
				Getting Started
			</div>
		</div>
		<div class="flex justify-center p-16 basis-5/12">
			<img src="src/assets/logo2.svg" alt="Logo2" />
		</div>
	</div>
</div>
